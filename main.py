...
if __name__ == "__main__":
    ...
    application = Application.builder().token(BOT_TOKEN).read_timeout(40).get_updates_read_timeout(40).connect_timeout(
        40).write_timeout(40).get_updates_connect_timeout(40).build()
    # handlers
    ...
    application.run_polling(allowed_updates=Update.ALL_TYPES, poll_interval=0.5, timeout=20, read_timeout=20,
                            write_timeout=20)
